            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <input type="file" class="dropify" data-default-file="../../../images/file-icons/64/001-interface-1.png" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <input type="file" class="dropify" data-height="300" data-default-file="../../../images/file-icons/128/001-interface-1.png" />
                </div>
              </div>
            </div>
          </div>
