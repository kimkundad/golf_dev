...
<html class="fixed sidebar-left-xs">
    ...
    <!-- Bootstrap Core CSS -->
    @include('admin2.layouts.inc-stylesheet')
	@yield('admin2.stylesheet')
    ...
    <section class="body">
        ...
        <header class="header">
                <div class="logo-container">
                  ...
                  <!--  <img src="{{url('assets/image/TOP657971755logo-website.png')}}" height="40"  /> -->
                </a>
                ...
                @include('admin2.layouts.inc-header')
                <!-- end: search & user box -->
            </header>
            <!-- end: header -->
...
@include('admin2.layouts.inc-left-slidebar')


                @yield('admin2.content')

                <!-- /.row -->
   </div>
@include('admin2.layouts.inc-right-sidebar')
    </section>
    <!-- /#section -->

    <!-- jQuery -->
	@include('admin2.layouts.inc-scripts')
    @yield('scripts')
