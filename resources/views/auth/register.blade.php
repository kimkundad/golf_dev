      ...
      <div class="sign-in-form style-1">
        ...
        <!-- Login -->
          <div class="tab-content margin-top-35 margin-bottom-35" id="tab1" >
            ...
            <a href="pages-booking.html" class="fb button book-now fullwidth margin-top-5"><i class="fa fa-facebook"></i>Sign Up With Facebook</a>
            <a href="pages-booking.html" class="google button book-now fullwidth margin-top-5"><i class="fa fa-google"></i> Sign Up With Google</a>
            <p class="text-center">
              OR
            </p>
