...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">{{$datahead}} <button type="button" onclick="window.location.href='{{url('admin/skill/create')}}'"
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td >
                      ...
                      <button type="button" style="float: left;padding: 10px;" onclick="window.location.href='{{url('admin/skill/'.$u->id.'/edit')}}'"  class="btn btn-icons btn-rounded btn-outline-warning"><i class="icon-settings"></i></button>
                      <form  action="{{url('admin/skill/'.$u->id)}}" method="post" onsubmit="return(confirm('Do you want Delete'))">
